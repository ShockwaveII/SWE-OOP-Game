...
automaton_factory_keeper.set_health(100)
automaton_factory_keeper.set_starting_health(100)
automaton_factory_keeper.set_lowest_dmg_value(0)
automaton_factory_keeper.set_highest_dmg_value(35)
...
boss_phase_2.set_health(110)
boss_phase_2.set_starting_health(110)
boss_phase_2.set_lowest_dmg_value(0)
boss_phase_2.set_highest_dmg_value(45)
